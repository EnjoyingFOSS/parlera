...
class MainRedirectScreen extends ConsumerWidget {
  const MainRedirectScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return ref.watch(tutorialCompletedProvider).when(
          ...
          data: (tutorialCompleted) {
            WidgetsBinding.instance.addPostFrameCallback(
                (_) async => Navigator.pushReplacementNamed(
                      context,
                      tutorialCompleted ? '/home' : '/tutorial',
                    ));
